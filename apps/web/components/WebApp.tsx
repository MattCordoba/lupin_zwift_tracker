    ...
    <ScrollView contentContainerStyle={styles.scrollContent}>
      <View style={styles.hero}>
        ...
        <View style={styles.heroPanel}>
          <Text style={styles.panelTitle}>Your rider profile</Text>
          <Text style={styles.panelBody}>
            Sign in to sync preferences across web and mobile. Set a default time
            budget so your rides fit the day.
          </Text>
          {!isFirebaseConfigured && (
            <Text style={styles.notice}>Add Firebase env vars to enable auth.</Text>
          )}
        </View>
      </View>
      ...
      <View style={styles.card}>
        ...
        {!loading && !user && (
          <View style={styles.section}>
            <Button
              label={isFirebaseConfigured ? "Continue with Google" : "Google auth unavailable"}
              onPress={isFirebaseConfigured ? () => signInWithGoogleWeb() : undefined}
            />
